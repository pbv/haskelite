...
SRC = src/AST.elm src/HsParser.elm src/Haskelite.elm src/Pretty.elm src/Machine.elm src/Heap.elm src/Context.elm src/Prelude.elm src/Typecheck.elm src/Unify.elm src/Tc.elm
