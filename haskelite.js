	...
	return A2(
		...
		A2(
			...
			A5(
				...
				i.z,
				i.w,
				$elm$parser$Parser$Advanced$token(i.y),
				i.A)));
};
	...
	return $elm$parser$Parser$Advanced$sequence(
		{
			...
			w: i.w,
			y: $elm$parser$Parser$toToken(i.y),
			z: i.z,
		...
		_List_fromArray(
			[
				...
				$elm$parser$Parser$sequence(
					{
						u: ']',
						w: $elm$parser$Parser$lazy(
							function (_v0) {
								return $author$project$HsParser$cyclic$pattern();
							}),
						y: ',',
						z: $author$project$HsParser$spaces,
						t: '[',
						A: 0
					})),
...
var $author$project$HsParser$identifierList = $elm$parser$Parser$sequence(
	{u: '', w: $author$project$HsParser$identifier, y: '', z: $author$project$HsParser$spaces, t: '', A: 0});
		...
		A2(
			...
			A2(
				...
				$elm$parser$Parser$succeed(
					F3(
						function (e1, f, e2) {
							return A3($author$project$AST$InfixOp, f, e1, e2);
						})),
				A2(
					$elm$parser$Parser$ignorer,
					A2(
...
function $author$project$HsParser$cyclic$delimitedList() {
	return $elm$parser$Parser$sequence(
		{
			u: '',
			w: $author$project$HsParser$cyclic$delimited(),
			y: '',
			z: $author$project$HsParser$spaces,
			t: '',
			A: 0
...
var $author$project$HsParser$patternList = $elm$parser$Parser$sequence(
	{u: '', w: $author$project$HsParser$pattern, y: '', z: $author$project$HsParser$spaces, t: '', A: 0});
...
var $author$project$HsParser$declList = $elm$parser$Parser$sequence(
	{u: '', w: $author$project$HsParser$declaration, y: '', z: $author$project$HsParser$whitespace, t: '', A: 2});
...
var $author$project$Prelude$functions = A2($author$project$Eval$collectFunctions, $author$project$Prelude$declarations, $elm$core$Dict$empty);
...
var $author$project$Haskelite$init = function (config) {
	var outputExpr = A2(
		...
		A2($elm$parser$Parser$run, $author$project$HsParser$topExprEnd, config.e));
	var outputDecls = A2(
		$elm$core$Result$mapError,
		$author$project$Pretty$deadEndsToString,
	...
	if ((!_v0.a.$) && (!_v0.b.$)) {
		...
		return _Utils_Tuple2(
			{
				e: expr,
				v: A2($author$project$Eval$collectFunctions, decls, $author$project$Prelude$functions),
				S: config.Z,
				T: config.e,
				I: 1,
				N: outputDecls,
		...
		return _Utils_Tuple2(
			{
				e: $author$project$AST$Fail('syntax'),
				v: $author$project$Prelude$functions,
				S: config.Z,
				T: config.e,
				I: 0,
				N: outputDecls,
...
var $author$project$Eval$dispatchBeta = F3(
	function (vars, body, args) {
		var nvars = $elm$core$List$length(vars);
		var nargs = $elm$core$List$length(args);
		if (_Utils_cmp(nargs, nvars) < 0) {
			return $elm$core$Maybe$Nothing;
		} else {
			var info = 'beta reduction';
			var args2 = A2($elm$core$List$drop, nvars, args);
			var args1 = A2($elm$core$List$take, nvars, args);
			var s = $elm$core$Dict$fromList(
				A3($elm$core$List$map2, $elm$core$Tuple$pair, vars, args1));
			var ne = A2(
				$author$project$Eval$applyArgs,
				A2($author$project$AST$applySubst, s, body),
				args2);
			return $elm$core$Maybe$Just(
					...
					if ((e.a.$ === 2) && e.b.b) {
						if (!e.b.b.b) {
							...
							if (!e.b.b.b.b) {
								...
								if ((e.a.a === 'enumFromThenTo') && (!e.b.b.b.b.b)) {
									var _v6 = e.b;
									var e1 = _v6.a;
									var _v7 = _v6.b;
									var e2 = _v7.a;
	...
	function (op, func, globals, args) {
		if ((args.b && args.b.b) && (!args.b.b.b)) {
			if ((args.a.$ === 3) && (args.b.a.$ === 3)) {
				...
				var _v66 = args.b;
				var arg2 = _v66.a;
				if ($author$project$Eval$isWeakNormalForm(arg1) && $author$project$Eval$isWeakNormalForm(arg2)) {
					return $elm$core$Maybe$Just(
						_Utils_Tuple2(
							$author$project$AST$Fail('type error: operator requires numbers'),
							op));
				} else {
					var _v67 = A2($author$project$Eval$redex, globals, arg1);
					if (!_v67.$) {
						var _v68 = _v67.a;
						var narg1 = _v68.a;
						var info = _v68.b;
						return $elm$core$Maybe$Just(
							_Utils_Tuple2(
								A3($author$project$AST$InfixOp, op, narg1, arg2),
								info));
					} else {
						var _v69 = A2($author$project$Eval$redex, globals, arg2);
						if (!_v69.$) {
							var _v70 = _v69.a;
							var narg2 = _v70.a;
							var info = _v70.b;
							return $elm$core$Maybe$Just(
								_Utils_Tuple2(
									A3($author$project$AST$InfixOp, op, arg1, narg2),
									info));
						} else {
							return $elm$core$Maybe$Nothing;
						}
		...
		if ((args.b && args.b.b) && (!args.b.b.b)) {
			if ((args.a.$ === 3) && (args.b.a.$ === 3)) {
				...
				if ($author$project$Eval$isWeakNormalForm(arg1) && $author$project$Eval$isWeakNormalForm(arg2)) {
					...
					var _v60 = A2($author$project$Eval$redex, globals, arg1);
					if (!_v60.$) {
						var _v61 = _v60.a;
						var narg1 = _v61.a;
						var info = _v61.b;
						...
						var _v62 = A2($author$project$Eval$redex, globals, arg2);
						if (!_v62.$) {
							var _v63 = _v62.a;
							var narg2 = _v63.a;
							var info = _v63.b;
...
var $author$project$Eval$dispatchAlts = F4(
	function (globals, fun, alts, args) {
		dispatchAlts:
		while (true) {
			if (!alts.b) {
				return $elm$core$Maybe$Just(
				...
				if (_Utils_cmp(nargs, nps) < 0) {
					...
					var _v54 = A4($author$project$Eval$patternEvalList, globals, ps, args1, _List_Nil);
					if (!_v54.$) {
						var _v55 = _v54.a;
						var nargs1 = _v55.a;
						var info = _v55.b;
						...
						var _v56 = A3($author$project$Eval$matchingList, ps, args1, $elm$core$Dict$empty);
						if (_v56.$ === 1) {
							var $temp$globals = globals,
								$temp$fun = fun,
								$temp$alts = alts1,
								$temp$args = args;
...
var $author$project$Eval$enumFrom = F2(
		...
		if (args.b && (!args.b.b)) {
			if (args.a.$ === 3) {
				...
				return A2(
					...
					A2($author$project$Eval$redex, globals, e1));
			}
		} else {
			return $elm$core$Maybe$Nothing;
		}
	});
var $author$project$Eval$enumFromThen = F2(
	function (globals, args) {
		if ((args.b && args.b.b) && (!args.b.b.b)) {
			if ((args.a.$ === 3) && (args.b.a.$ === 3)) {
				var a1 = args.a.a;
				...
				var _v46 = args.b;
				var e2 = _v46.a;
				var _v47 = A2($author$project$Eval$redex, globals, e1);
				if (!_v47.$) {
					var _v48 = _v47.a;
					var ne1 = _v48.a;
					var info = _v48.b;
					...
					return A2(
						...
						A2($author$project$Eval$redex, globals, e2));
				}
			}
		} else {
			return $elm$core$Maybe$Nothing;
...
var $author$project$Eval$enumFromThenTo = F2(
	function (globals, args) {
		if (((args.b && args.b.b) && args.b.b.b) && (!args.b.b.b.b)) {
			if (((args.a.$ === 3) && (args.b.a.$ === 3)) && (args.b.b.a.$ === 3)) {
				var a1 = args.a.a;
				var _v35 = args.b;
				var a2 = _v35.a.a;
				var _v36 = _v35.b;
				...
				var _v38 = _v37.b;
				var e3 = _v38.a;
				var _v39 = A2($author$project$Eval$redex, globals, e1);
				if (!_v39.$) {
					var _v40 = _v39.a;
					var ne1 = _v40.a;
					var info = _v40.b;
					...
					var _v41 = A2($author$project$Eval$redex, globals, e2);
					if (!_v41.$) {
						var _v42 = _v41.a;
						var ne2 = _v42.a;
						var info = _v42.b;
						...
						return A2(
							...
							A2($author$project$Eval$redex, globals, e3));
					}
				}
			}
		} else {
...
var $author$project$Eval$enumFromTo = F2(
	function (globals, args) {
		if ((args.b && args.b.b) && (!args.b.b.b)) {
			if ((args.a.$ === 3) && (args.b.a.$ === 3)) {
				var a = args.a.a;
				...
				var _v30 = args.b;
				var e2 = _v30.a;
				var _v31 = A2($author$project$Eval$redex, globals, e1);
				if (!_v31.$) {
					var _v32 = _v31.a;
					var ne1 = _v32.a;
					var info = _v32.b;
...
var $author$project$Eval$patternEval = F3(
	function (globals, p, e) {
		var _v12 = _Utils_Tuple2(p, e);
		_v12$9:
		while (true) {
			switch (_v12.a.$) {
				case 0:
					...
					if (_v12.b.$ === 7) {
						...
						return A2(
							...
							function (_v13) {
								...
								return $elm$core$Maybe$Just(
									_Utils_Tuple2(
										$author$project$AST$TupleLit(nes),
										info));
							},
							A4($author$project$Eval$patternEvalList, globals, ps, es, _List_Nil));
					} else {
						break _v12$9;
					}
				case 3:
						...
						case 6:
							...
							return A2(
								...
								function (_v14) {
									...
									return $elm$core$Maybe$Just(
										_Utils_Tuple2(
											$author$project$AST$ListLit(nes),
											info));
								},
								A4($author$project$Eval$patternEvalList, globals, ps, es, _List_Nil));
						case 5:
							if (!_v12.a.a.b) {
								...
								var e1 = _v17.a;
								var e2 = _v17.b;
								var _v18 = A3($author$project$Eval$patternEval, globals, p1, e1);
								if (!_v18.$) {
									var _v19 = _v18.a;
									var ne1 = _v19.a;
									var info = _v19.b;
									return $elm$core$Maybe$Just(
										_Utils_Tuple2(
											A2($author$project$AST$Cons, ne1, e2),
											info));
								} else {
									return A2(
										$elm$core$Maybe$andThen,
										function (_v20) {
											...
											return $elm$core$Maybe$Just(
												_Utils_Tuple2(
													A2($author$project$AST$Cons, e1, ne2),
													info));
										},
										A3(
											$author$project$Eval$patternEval,
											globals,
											$author$project$AST$ListP(ps),
											e2));
								}
				...
				default:
					if (_v12.b.$ === 6) {
						if (!_v12.b.a.b) {
							...
							var e1 = _v23.a;
							var rest = _v23.b;
							var _v24 = A3($author$project$Eval$patternEval, globals, p1, e1);
							if (!_v24.$) {
								var _v25 = _v24.a;
								var ne1 = _v25.a;
								var info = _v25.b;
								return $elm$core$Maybe$Just(
									_Utils_Tuple2(
										$author$project$AST$ListLit(
											A2($elm$core$List$cons, ne1, rest)),
										info));
							} else {
								return A2(
									$elm$core$Maybe$andThen,
									function (_v26) {
										...
										if (nrest_.$ === 6) {
											...
											return $elm$core$Maybe$Just(
												_Utils_Tuple2(
													$author$project$AST$ListLit(
														A2($elm$core$List$cons, e1, nrest)),
													info));
										} else {
											return $elm$core$Maybe$Nothing;
										}
		...
		return A2($author$project$Eval$redex, globals, e);
	});
var $author$project$Eval$patternEvalList = F4(
	function (globals, patts, exprs, accum) {
		patternEvalList:
		while (true) {
			var _v7 = _Utils_Tuple2(patts, exprs);
			if (_v7.a.b && _v7.b.b) {
				var _v8 = _v7.a;
				var p1 = _v8.a;
				var ps = _v8.b;
				...
				var e1 = _v9.a;
				var es = _v9.b;
				var _v10 = A3($author$project$Eval$patternEval, globals, p1, e1);
				if (!_v10.$) {
					var _v11 = _v10.a;
					var ne1 = _v11.a;
					var info = _v11.b;
					return $elm$core$Maybe$Just(
						_Utils_Tuple2(
							_Utils_ap(
								...
								A2($elm$core$List$cons, ne1, es)),
							info));
				} else {
					var $temp$globals = globals,
						$temp$patts = ps,
						$temp$exprs = es,
						$temp$accum = A2($elm$core$List$cons, e1, accum);
					globals = $temp$globals;
					patts = $temp$patts;
					exprs = $temp$exprs;
					accum = $temp$accum;
					continue patternEvalList;
				}
			} else {
				return $elm$core$Maybe$Nothing;
			}
					...
					case 0:
						...
						switch (_v1.a.$) {
							case 1:
								...
								var e0 = _v2.b;
								var args = _v1.b;
								return A3($author$project$Eval$dispatchBeta, xs, e0, args);
							case 2:
								var fun = _v1.a.a;
								var args = _v1.b;
								var _v3 = A2($elm$core$Dict$get, fun, globals);
								if (!_v3.$) {
									var alts = _v3.a;
									return A4($author$project$Eval$dispatchAlts, globals, fun, alts, args);
								} else {
									var _v4 = A2(
										$elm$core$Dict$get,
										fun,
										$author$project$Eval$cyclic$primitives());
									if (!_v4.$) {
										var prim = _v4.a;
										return A2(prim, globals, args);
									} else {
										return $elm$core$Maybe$Just(
											_Utils_Tuple2(
						...
						if (e1.$ === 4) {
							...
							return $author$project$Eval$isWeakNormalForm(e1) ? $elm$core$Maybe$Just(
								...
								function (_v6) {
									...
									return $elm$core$Maybe$Just(
										_Utils_Tuple2(
											A3($author$project$AST$IfThenElse, ne1, e2, e3),
											info));
								},
								A2($author$project$Eval$redex, globals, e1));
						}
...
function $author$project$Eval$cyclic$primitives() {
	return $elm$core$Dict$fromList(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'/=',
				A2($author$project$Eval$compareOp, '/=', $elm$core$Basics$neq)),
				_Utils_Tuple2(
				'==',
				A2($author$project$Eval$compareOp, '==', $elm$core$Basics$eq)),
				_Utils_Tuple2(
				'>=',
...
$author$project$Eval$cyclic$primitives = function () {
	return $author$project$Eval$primitives;
};
...
var $author$project$Eval$outermostRedex = F2(
	function (globals, expr) {
		var _v6 = A2($author$project$Eval$redex, globals, expr);
		if (!_v6.$) {
			return $elm$core$Maybe$Just($author$project$Context$hole);
		} else {
			return A2($author$project$Eval$outermostRedexAux, globals, expr);
		}
	});
	...
	function (functions, proj, args, i) {
		...
		while (true) {
			if (args.b) {
				var arg = args.a;
				var rest = args.b;
				var _v5 = A2($author$project$Eval$outermostRedex, functions, arg);
				if (!_v5.$) {
					var ctx = _v5.a;
					return $elm$core$Maybe$Just(
						A2(
	...
	function (globals, expr) {
		switch (expr.$) {
			case 5:
				var e0 = expr.a;
				var e1 = expr.b;
				var _v1 = A2($author$project$Eval$outermostRedex, globals, e0);
				if (!_v1.$) {
					var ctx = _v1.a;
					return $elm$core$Maybe$Just(
						A2($arturopala$elm_monocle$Monocle$Optional$compose, $author$project$Context$cons0, ctx));
				} else {
					var _v2 = A2($author$project$Eval$outermostRedex, globals, e1);
					if (!_v2.$) {
						var ctx = _v2.a;
						return $elm$core$Maybe$Just(
			...
			case 7:
				var items = expr.a;
				return A4($author$project$Eval$outermostRedexArgs, globals, $author$project$Context$tupleItem, items, 0);
			case 6:
				var items = expr.a;
				return A4($author$project$Eval$outermostRedexArgs, globals, $author$project$Context$listItem, items, 0);
			case 9:
				var e0 = expr.a;
				var e1 = expr.b;
				var e2 = expr.c;
				var _v3 = A2($author$project$Eval$outermostRedex, globals, e0);
				if (!_v3.$) {
					var ctx = _v3.a;
					return $elm$core$Maybe$Just(
...
var $author$project$Haskelite$reduceNext = F2(
	function (globals, expr) {
		return A2(
			$elm$core$Maybe$andThen,
			function (ctx) {
				return A3($author$project$Eval$redexCtx, globals, expr, ctx);
			},
			A2($author$project$Eval$outermostRedex, globals, expr));
	});
var $author$project$Haskelite$reduceUpdate = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var ctx = msg.a;
				var _v1 = A3($author$project$Eval$redexCtx, model.v, model.e, ctx);
				if (!_v1.$) {
					var _v2 = _v1.a;
					var newExpr = _v2.a;
					var info = _v2.b;
			...
			case 2:
				var _v5 = A2($author$project$Haskelite$reduceNext, model.v, model.e);
				if (!_v5.$) {
					var _v6 = _v5.a;
					var newExpr = _v6.a;
					var info = _v6.b;
			...
			case 3:
				var _v7 = $elm_community$list_extra$List$Extra$last(model.j);
				if (!_v7.$) {
					var _v8 = _v7.a;
					var expr = _v8.a;
					return _Utils_update(
	...
	function (prec, functions, expr, ctx) {
		...
		while (true) {
			switch (expr.$) {
				...
				case 0:
					if ((expr.a.$ === 2) && expr.b.b) {
						if (!expr.b.b.b) {
							if (expr.a.a === 'enumFrom') {
								var _v1 = expr.b;
								var e0 = _v1.a;
								var ctx0 = A2(
									$arturopala$elm_monocle$Monocle$Optional$compose,
									ctx,
									$author$project$Context$appArg(0));
								return A2(
									$elm$html$Html$span,
									_List_Nil,
									_List_fromArray(
							...
							if (!expr.b.b.b.b) {
								switch (expr.a.a) {
									case 'enumFromThen':
										...
										var ctx1 = A2(
											$arturopala$elm_monocle$Monocle$Optional$compose,
											ctx,
											$author$project$Context$appArg(1));
										var ctx0 = A2(
											$arturopala$elm_monocle$Monocle$Optional$compose,
											ctx,
											$author$project$Context$appArg(0));
								...
								if ((expr.a.a === 'enumFromThenTo') && (!expr.b.b.b.b.b)) {
									var _v6 = expr.b;
									var e0 = _v6.a;
									var _v7 = _v6.b;
									var e1 = _v7.a;
									...
									var ctx2 = A2(
										$arturopala$elm_monocle$Monocle$Optional$compose,
										ctx,
										$author$project$Context$appArg(2));
									var ctx1 = A2(
										$arturopala$elm_monocle$Monocle$Optional$compose,
										ctx,
										$author$project$Context$appArg(1));
...
var $author$project$Haskelite$lastLineView = function (model) {
	var _v0 = model.j;
	if (!_v0.b) {
		return A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3($author$project$Haskelite$renderExpr, model.v, model.e, $author$project$Context$hole)
						]))
				]));
	} else {
		var _v1 = _v0.a;
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					$author$project$Pretty$prettyExpr(last)),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
...
var $author$project$Haskelite$previousView = function (model) {
	var _v0 = model.j;
	if (!_v0.b) {
		return _List_Nil;
	} else {
	...
	return A2(
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('navbar'),
								$elm$html$Html$Attributes$disabled(
								A2($author$project$Haskelite$isNormalForm, model.v, model.e)),
				...
				_Utils_ap(
					$author$project$Haskelite$previousView(model),
					_List_fromArray(
						[
							$author$project$Haskelite$lastLineView(model)
						])))
			]));
};
